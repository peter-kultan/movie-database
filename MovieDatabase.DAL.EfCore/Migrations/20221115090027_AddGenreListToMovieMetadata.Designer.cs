...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CountryTVSeriesMetadata", b =>
                {
                    ...
                    b.HasKey("OriginCountriesId", "SeriesId");

                    b.HasIndex("SeriesId");

                    b.ToTable("CountryTVSeriesMetadata");
                });
            ...
            modelBuilder.Entity("MovieDatabase.DAL.EfCore.Models.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CountryTVSeriesMetadata", b =>
                {
                    b.HasOne("MovieDatabase.DAL.EfCore.Models.Country", null)
                        .WithMany()
                        .HasForeignKey("OriginCountriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MovieDatabase.DAL.EfCore.Models.TVSeriesMetadata", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MovieDatabase.DAL.EfCore.Models.Genre", b =>
                {
                    b.HasOne("MovieDatabase.DAL.EfCore.Models.MovieMetadata", null)
                        .WithMany("Genres")
